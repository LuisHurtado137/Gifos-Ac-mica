...
export default function Search(){
    ...
    return(
        <ThemeProvider theme={theme === "Light" ? lightTheme : darkTheme} onChange={handleTheme}>
           <StyledApp className={`container-search-gifs ${theme === "Light" ? "darkTheme": "lightTheme"}`}>
            <form onSubmit={handleOnSubmit}>
                ...
                <div className="input-container">
                    ...
                    />
                    <div className="lupa" onClick={handlerClick}>
                        <img src={lupa} alt="lupa" className="lupa-buscador"/>
                    </div> 
                </div>
                {searchData}
            </form>                
